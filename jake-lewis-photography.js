document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch(link_publicPhotos)
        ...
        .then(data => {
            ...
            //my Photos is a section containing the populated photos
            const myPhotos = document.getElementById('myPhotos');
            const publicPhotosArray = data.photos.photo;
            ...
            for (let i = 0; i < publicPhotosArray.length; i++) {
                ...
                photo_element.classList.add('materialboxed', 'pictures', 'z-depth-4');
